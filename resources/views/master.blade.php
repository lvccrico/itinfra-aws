...
<body>
    ...
    <footer>
        <div class="container">
            <hr/>
            <p class="text-muted">This site is a requirements for our IT Infrastructure subject @ La Verdad Christian College Apalit Pampanga.</p>
            <p class="text-muted">Created by <a href="https://github.com/lvccrico">Rico Custodio</a> BSIS 3</p>
        </div>
    </footer>
